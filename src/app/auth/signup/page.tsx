...
const locations = [
  ...
  { value: 'chicago', label: '📍 Greater Chicago, USA' },
  { value: 'remote', label: '🌐 Remote / Both' },
]
    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem 1.5rem' }}>
      <div style={{ width: '100%', maxWidth: '520px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--hsn-dark)' }}>Join the Network</h1>
          <p style={{ color: 'var(--hsn-gray)', marginTop: '0.4rem', fontSize: '0.9rem' }}>Connect with the Muslim community in Hyderabad & Chicago</p>
        </div>
        ...
        <div className="card" style={{ padding: '2rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <span style={{ fontSize: '0.8rem', color: 'var(--hsn-gray)', whiteSpace: 'nowrap' }}>or sign up with email</span>
            <div style={{ flex: 1, height: '1px', background: 'var(--hsn-border)' }} />
          </div>
          ...
          <form action={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.25rem' }}>
              ...
              <input name="full_name" type="text" required placeholder="Your full name" style={inputStyle} />
            </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.25rem', fontSize: '0.875rem', color: 'var(--hsn-gray)' }}>
          ...
          <Link href="/auth/login" style={{ color: 'var(--hsn-green)', fontWeight: 600, textDecoration: 'none' }}>
            Sign in
          </Link>
        </p>
      </div>
